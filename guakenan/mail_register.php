...
$address = $useremail;//收件人email
$mail->AddAddress($useremail, "挂科难注册账户");//添加收件人地址，昵称

$mail->IsHTML(true); //支持html格式内容 

$verify="<a href='http://localhost/guakenan/verify.php?username=" . $username . "' target= '_blank'>您要验证的注册账号为：" . $username . "</a>";
